...
# Print the describe data frames for verification
print(mort_pop[1].describe)
print(population[1].describe)
print(urban_population_t[1].describe)
print(electric_power_t[1].describe)
...
plt.title('Mortality rate, under-5 (per 1,000 live births) of different countries')
plt.show()
...
plt.xlabel("Years")
plt.ylabel('Urban population (% of total population) of different countries')
plt.show()
...
x=["Population, total","CO2 emissions from gaseous fuel consumption (% of total)","Energy use (kg of oil equivalent per capita)","Renewable energy consumption (% of total final energy consumption)"]
